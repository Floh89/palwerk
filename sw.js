const CACHE='palwerk-shell-v9';
const ASSETS=['./','./index.html','./src/styles.css','./src/app.js','./src/team-optimizer.js','./src/storage.js','./src/catalog.js','./src/catalog-pack-5.js','./manifest.webmanifest','./assets/icon.svg'];
