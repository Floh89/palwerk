const CACHE='palwerk-shell-v8';
const ASSETS=['./','./index.html','./src/styles.css','./src/app.js','./src/team-optimizer.js','./src/storage.js','./src/catalog.js','./manifest.webmanifest','./assets/icon.svg'];
