const CACHE='palwerk-shell-v11';
const ASSETS=['./','./index.html','./src/styles.css','./src/app.js','./src/team-optimizer.js','./src/storage.js','./src/catalog.js','./src/catalog-pack-5.js','./src/catalog-pack-6.js','./src/catalog-pack-7.js','./manifest.webmanifest','./assets/icon.svg'];
